			...
			@include('utils.sidebar-seller')
				...
				<h3>Summary</h3>
					<div class="row">
						...
						<div class="grid_o col-md-10">
							<div class="grid_">
								<i class="fa fa-plus"></i> Create your promotion
							</div>
						</div>
						</a>
						@endif
						<div class="grid_o col-md-5">
							<div class="grid_">
							<i class="fa fa-tags"></i> {{$num_product==0?"No":$num_product}} promotion{{$num_product>1?"s":""}} created
							</div>
						</div>
						<div class="grid_o col-md-5">
							<div class="grid_">
							<i class="fa fa-desktop"></i> {{$num_product_moderate==0?"No":$num_product_moderate}} promotion{{$num_product_moderate>1?"s":""}} in moderated 
							</div>
						</div>
						<div class="grid_o col-md-5">
							<div class="grid_">
							<i class="fa fa-check"></i> {{$num_product_approved==0?"No":$num_product_approved}} promotion{{$num_product_approved>1?"s":""}} published 
							</div>
						</div>
						<div class="grid_o col-md-5">
							<div class="grid_">
							<i class="fa fa-times"></i> {{$num_product_declined==0?"No":$num_product_declined}} promotion{{$num_product_declined>1?"s":""}} declined 
							</div>
						</div>
						@endif
					</div>
